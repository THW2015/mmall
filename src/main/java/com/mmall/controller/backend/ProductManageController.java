...
public class ProductManageController {
    ...
    @ResponseBody
    public ServerResponse product(HttpServletRequest request, Product product){
...
//        if(user == null){
//            return ServerResponse.createByCodeErrorMessage(ResponseCode.NEED_LOGIN.getCode(),
//                    "用户未登录，请登录管理员");
//        }
...
//        }
    ...
    @ResponseBody
    public ServerResponse setSaleStatus(HttpServletRequest request, Product product){
//        String loginToken = CookieUtil.readLoginToken(request);
//        if (StringUtils.isEmpty(loginToken)) {
//            return ServerResponse.createByErrorMessage("用户未登录,无法获取用户信息");
//        }
...
//        }
    ...
    @ResponseBody
    public ServerResponse getDetailRestful(HttpServletRequest request, @PathVariable Integer productId){
//        String loginToken = CookieUtil.readLoginToken(request);
//        if (StringUtils.isEmpty(loginToken)) {
//            return ServerResponse.createByErrorMessage("用户未登录,无法获取用户信息");
//        }
